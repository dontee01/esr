    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-body">
                ...
                <h6 class="card-subtitle text-primary"> Please ensure you specify the right recipient and amount you want to transfer </h6>
                <form class="form-horizontal m-t-40" method="post" action="{{ url('transfer/init')}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="amount" placeholder="Amount you want to transfer" required="required" value="{{ old('amount') }}">
                    </div>
